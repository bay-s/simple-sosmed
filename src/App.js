...
this.setState({hide:!this.state.hide});
  ...
  render(){
    ...
    return (
      ...
      <Route path="/post/:id" element={this.state.isLogin ? <PostDetail id={this.state.uid} name={this.state.akunUserName} avatar={this.state.akunImages} /> : <LoginPage isSubmit={this.state.isSubmit} total_post={this.state.totalPost} sukses={this.state.sukses}  error={this.state.error} pesan={this.state.pesan} loginValidasi={this.loginValidasi} handlerChange={this.handlerChange}/>} />
      ...
      <Route path="/message/:id" element={this.state.isLogin ? <MessageDetail name={this.state.akunUserName} avatar={this.state.akunImages} ID={this.state.uid} isLogin={this.state.isLogin} /> : <LoginPage isSubmit={this.state.isSubmit} sukses={this.state.sukses}  error={this.state.error} pesan={this.state.pesan} loginValidasi={this.loginValidasi} handlerChange={this.handlerChange}/>}/>
