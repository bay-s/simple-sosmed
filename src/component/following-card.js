...
async componentDidUpdate(){
    ...
    render(){
        ...
        return(
            this.props.follow_id == null ? <h4 className='text-center is-title is-6'>No following yet</h4> : <div className='profiles is-flex is-justify-content-space-between is-align-items-center mx-3'>
