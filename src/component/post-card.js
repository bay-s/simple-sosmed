...
// <Link to={`/post/${this.props.data.post_id}`} dataset={this.props.data.post_id} onClick={this.openModalPost}>
...
// <ModalPostDetail modalDelete={this.openModalDelete }/>
...
//  <div class="modal-background"></div>
// <ModalDelete modalDelete={this.openModalDelete } deletePost={this.deletePost} />
