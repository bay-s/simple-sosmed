    ...
    <aside class="column is-2 ">
        <div>
            <div class="is-flex is-flex-column">
                <a href="#" class="button is-flex align-center is-flex-gap-sm"><span class="icon"><i class="fa fa-inbox"></i></span><span class="name">Inbox</span><span className='has-text-info is-bold is-title'>{this.state.listMessage.length < 1 ? "" : this.state.listMessage.length}</span></a>
                <a href="#" class="button is-flex align-center is-flex-gap-sm"><span class="icon"><i class="fa fa-envelope-o"></i></span><span class="name">Sent Message</span><span className='has-text-info is-bold is-title'>{this.state.listSent.length < 1 ? "" : this.state.listSent.length}</span></a>
                <a href="#" class="button"><span class="icon"><i class="fa fa-folder-o"></i></span><span class="name">Folders</span></a>
            </div>
        </div>
    </aside>
    <div class="column is-4 messages hero card is-flex-column is-flex-gap-md" >
   {messasgeCard }
    </div>
</div>
</div> */}