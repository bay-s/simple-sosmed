...
<form class="field is-grouped box is-flex is-flex-direction-column is-align-items-center has-text-centered p-0" deleteAccount={props.deleteAccount}>
<div className='py-2 my-2'>
<p className='is-size-7 is-title is-bold'>Delete post?</p>
  <p className='subtitle is-size-7 mt-2'>Are you sure you want to delete this Account?</p>
</div>
