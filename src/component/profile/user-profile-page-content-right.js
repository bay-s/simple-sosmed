...
function UserPageContentRight(props){
    ...
    return(
        ...
        <div className='is-flex justify-between align-center mb-4'>
           ...
           <li className='is-flex align-center is-flex-gap-md'>
             ...
             <a href={props.data.link_website}>www.website.com</a>
             </li>
           ...
           <div className='is-flex justify-between align-center my-5'>
            <h3 className='is-title is-bold is-5'>Skill</h3>
           </div>
...
export default UserPageContentRight;