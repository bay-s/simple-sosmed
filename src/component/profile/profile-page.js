...
closeModal = e  => {
  ...
  this.setState({
    ...
    modalEdit:this.state.modalEdit = false
  })
}
...
console.log(this.state.modalSkills);
}
...
<ProfilePageContentLeft openModal={this.openModal } data={this.state.data} isLogin={this.props.isLogin} ID={this.props.ID} dataPost={this.state.dataPost.docs}/>    
  {/* END COLUMN LEFT */}
<ProfilePageContentRight skills={this.state.skills} openModalSkills={this.openModalSkills} data={this.state.data}/>   
   {/* END COLUMN RIGHT */}
    </div>
    {/* END COLUMNS INNER */}
</div>
...
<div className={this.state.modalDelete ? 'modal is-active' : 'modal'}>
 ...
 <div className={this.state.modalSkills ? 'modal' : 'modal is-active '}>
